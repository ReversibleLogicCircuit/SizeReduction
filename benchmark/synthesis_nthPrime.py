...
resultsGates = []
gatesForPre = []
# 0.5:0.5:0 of nthPrime3 is already done.
if n == 4:
    # sepecific gates for converting state to 0.5:0.5:0 of nthPrime4
    gatesForPre.append([n-n, [[n-1,1], [n-2,1], [n-3,1]]])                                      # C^{3}X
elif n == 5:
    # sepecific gates for converting state to 0.5:0.5:0 of nthPrime5
    gatesForPre.append([n-3, [[n-2,1]]])                                                        # C^{1}X
    gatesForPre.append([n-n, [[n-1,0], [n-3,1]]])                                               # C^{2}X
    gatesForPre.append([n-n, [[n-1,0], [n-2,1], [n-3,0], [n-4,0]]])                             # C^{4}X
elif n == 6:
    # sepecific gates for converting state to 0.5:0.5:0 of nthPrime6
    gatesForPre.append([n-n, [[n-1,1], [n-2,1], [n-3,1], [n-4,1], [n-5,1]]])                    # C^{5}X
elif n == 7:
    # sepecific gates for converting state to 0.5:0.5:0 of nthPrime7
    gatesForPre.append([n-n, [[n-1,0], [n-2,1], [n-3,0], [n-4,0], [n-5,0], [n-6,0]]])           # C^{6}X
    gatesForPre.append([n-n, [[n-1,0], [n-2,0], [n-3,1]]])                                      # C^{3}X
    gatesForPre.append([n-n, [[n-1,0], [n-2,0], [n-3,0]]])                                      # C^{3}X
    gatesForPre.append([n-n, [[n-1,0], [n-2,0], [n-3,0], [n-4,0], [n-5,0]]])                    # C^{5}X
    gatesForPre.append([n-n, [[n-1,1], [n-2,1], [n-3,1]]])                                      # C^{3}X
    gatesForPre.append([n-n, [[n-1,1], [n-2,1], [n-3,1], [n-4,0], [n-5,0], [n-6,0]]])           # C^{6}X
    gatesForPre.append([n-n, [[n-1,0], [n-2,0], [n-3,1], [n-4,1], [n-5,1], [n-6,1]]])           # C^{6}X
    gatesForPre.append([n-n, [[n-1,0], [n-2,1], [n-3,1], [n-4,0], [n-5,1]]])                    # C^{5}X
    gatesForPre.append([n-n, [[n-1,1], [n-2,0], [n-3,0], [n-4,0], [n-5,0]]])                    # C^{5}X
elif n == 8:
    ...
    # sepecific gates for converting state to 0.5:0.5:0 of nthPrime9
    ...
    # sepecific gates for converting state to 0.5:0.5:0 of nthPrime11
    gatesForPre.append([n-n, [[n-1,0], [n-2,0], [n-3,0]]])                                                                  # c^{3}X
    ...
    # sepecific gates for converting state to 0.5:0.5:0 of nthPrime12
    gatesForPre.append([n-n, [[n-1,1], [n-2,1], [n-3,1], [n-4,1], [n-5,1], [n-6,1], [n-7,1], [n-8,1], [n-9,0], [n-10,0], [n-11,1]]])
    gatesForPre.append([n-n, [[n-1,1], [n-2,1], [n-3,1], [n-4,1], [n-5,1], [n-6,1], [n-7,1], [n-8,1], [n-9,0], [n-10,1]]])
