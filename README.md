## Python3 (and C) implementation of reversible logic circuit synthesis algorithm given by https://arxiv.org/abs/2107.04298
</br>
...
## ./source_c folder (new as of 2026.6.13.)
 1. The reversible logic circuit synthesis algorithm originally implemented in Python (`core.py` and `synthesis.py`) has been ported to C.
 2. The C implementation yields outputs identical to those generated by the Python implementation, while providing an approximately 1000-fold improvement in computational performance.
 3. Additional implementation details are available in the README file included in the `./source_c` folder.
 </br>
